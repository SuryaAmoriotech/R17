            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                    <input class="datepicker form-control" type="date" size="50" name="invoice_date" id="date" required value="" tabindex="4" />
                        </div>
                ...
                <input name="amount"  type="text" placeholder="Amount" required id="amount">
                    ...
                    <div class="form-group text-right">
                        ...
                        <button type="submit" style="float:right;color:white;background-color: #38469f;"  class="btn btn-success w-md m-b-5">Send</button>
